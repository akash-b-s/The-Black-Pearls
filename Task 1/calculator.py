...
bar = Entry(root, width=22, font=("Ubuntu", 18, "normal"), fg="black", bg="Pale Turquoise")
bar.place(x=5, y=3)
...
n0 = Button(root, text="0", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light cyan",
            command=lambda: insert("0"))
n0.place(x=X, y=(4 * Y) + 20)

####################################################################################################

dot = Button(root, text=".", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light cyan",
             command=lambda: insert("."))
dot.place(x=0, y=(4 * Y) + 20)

equal = Button(root, text="=", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light blue", command=Answer)
equal.place(x=2 * X, y=(4 * Y) + 20)

####################################################################################################

mult = Button(root, text="X", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light cyan",
              command=lambda: insert("*"))
mult.place(x=3 * X, y=Y + 20)

div = Button(root, text="/", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light cyan",
             command=lambda: insert("/"))
div.place(x=3 * X, y=(2 * Y) + 20)

plus = Button(root, text="+", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light cyan",
              command=lambda: insert("+"))
...
AC = Button(root, text="AC", font=("Courier New", 16, "bold"), padx=14, pady=6, bd=4, bg="blue", command=Delete)
AC.place(x=0, y=Y - 35)

back = Button(root, text=u"\u2190", font=("Courier New", 16, "bold"), padx=20, pady=6, bd=4, bg="light blue",
              command=BackSpace)
back.place(x=X, y=Y - 35)

Open = Button(root, text="(", font=("Courier New", 16, "bold"), padx=20, pady=6, bd=4, bg="light blue",
              command=lambda: insert("("))
Open.place(x=2 * X, y=Y - 35)

Close = Button(root, text=")", font=("Courier New", 16, "bold"), padx=20, pady=6, bd=4, bg="light blue",
               command=lambda: insert(")"))
